    ...
    <div>
      <div className={classes.container}>
        <div className={classes.wrapper}>
          ...
          <form onSubmit={handleCreateProduct} encType="multipart/form-data" className="">
            ...
            <div className={classes.inputWrapper}>
              ...
              <input type='text' placeholder='TitleDescription...' className={classes.input} onChange={(e) => setDesc(e.target.value)}/>
            </div>
            <div className={classes.inputWrapper}>
            ...
            <div className={classes.inputWrapperImage}>
              ...
              <input type='file' id="image" placeholder='Image...' className={classes.input} onChange={onChangeFile} style={{display:'none'}} />
              {image && <p className={classes.imageName}>{image.name} <AiOutlineCloseCircle onClick={handleCloseImg} className={classes.closeIcon}/></p>}
            </div>
            <div className={classes.inputWrapper}>
              <label>Price: </label>
              <input step={0.01} type='number' placeholder='Price...' className={classes.input} onChange={(e) => setPrice(e.target.value)}/>
            </div>
            <div className={classes.inputWrapper}>
              <label>Review: </label>
              <input type='number' step={0.1} min={1} max={5} placeholder='Review...' className={classes.input} onChange={(e) => setReview(e.target.value)}/>
            </div>
